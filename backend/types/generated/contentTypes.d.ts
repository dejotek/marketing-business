...
export interface ApiActionLogActionLog extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'System action logs for auditing and dashboard';
...
export interface ApiCourseProgressCourseProgress
  ...
  info: {
    description: 'Per-user course progress storage';
...
export interface ApiCourseCourse extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Courses for the membership portal';
    displayName: 'Course';
    pluralName: 'courses';
    singularName: 'course';
  };
...
export interface ApiDocumentDocument extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Uploaded documents and e-signature records';
  ...
  attributes: {
    ...
    name: Schema.Attribute.String;
    publishedAt: Schema.Attribute.DateTime;
    signed: Schema.Attribute.Boolean & Schema.Attribute.DefaultTo<false>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiFunnelFunnel extends Struct.CollectionTypeSchema {
  collectionName: 'funnels';
  info: {
    description: 'Sales funnels created by the builder';
    displayName: 'Funnel';
    pluralName: 'funnels';
    singularName: 'funnel';
  };
...
export interface ApiIntegrationSettingsIntegrationSettings
  extends Struct.CollectionTypeSchema {
  collectionName: 'integration_settings';
  info: {
    description: 'Storage for external integration configuration like Google, Twilio, Stripe';
    displayName: 'Integration Settings';
    pluralName: 'integration-settings-list';
    singularName: 'integration-settings';
  };
  options: {
    draftAndPublish: false;
  };
  attributes: {
    configured: Schema.Attribute.Boolean & Schema.Attribute.DefaultTo<false>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::integration-settings.integration-settings'
    > &
      Schema.Attribute.Private;
...
export interface ApiKalendarzKalendarz extends Struct.CollectionTypeSchema {
  collectionName: 'kalendarze';
  info: {
    description: 'Kalendarz - wydarzenia';
    displayName: 'Kalendarz';
    pluralName: 'kalendarze';
    singularName: 'kalendarz';
  };
  options: {
    draftAndPublish: true;
  };
...
export interface ApiPurchasePurchase extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Records of course purchases';
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::funnel.funnel': ApiFunnelFunnel;
      'api::integration-settings.integration-settings': ApiIntegrationSettingsIntegrationSettings;
      'api::kalendarz.kalendarz': ApiKalendarzKalendarz;
